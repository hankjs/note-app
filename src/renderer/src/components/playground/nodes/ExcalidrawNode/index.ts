...
export class ExcalidrawNode extends DecoratorNode<Component> implements ExcalidrawNodeInterface<Component> {
  __data: string;
  __width: Dimension;
  __height: Dimension;
  ...
  decorate(editor: LexicalEditor, config: EditorConfig): Component {
    return (
      h(ExcalidrawComponent, {
        nodeKey: this.getKey(),
        data: this.__data,
        width: this.__width,
        height: this.__height,
        isExcalidrawNode: $isExcalidrawNode
      })
    );
  }
}
