...
import { useLexicalComposer, useLexicalTextEntity } from "lexical-vue"
...
const $createKeywordNode_ = (textNode: TextNode): KeywordNode => {
  return $createKeywordNode(textNode.getTextContent())
}

const getKeywordMatch = (text: string) => {
